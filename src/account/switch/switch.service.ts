...
export class SwitchService {
    ...
    authenticate(finallyCallback?: () => void, redirectUrl?: string): void {
        ...
        this.authenticateModel.twoFactorRememberClientToken = this._utilsService.getCookieValue(SwitchService.twoFactorRememberClientTokenName);
        this.authenticateModel.singleSignIn = UrlHelper.getSingleSignIn();
        this.authenticateModel.returnUrl = UrlHelper.getReturnUrl();
		
		this.authenticateModel.userNameOrEmailAddress = sessionStorage.email;
		this.authenticateModel.password = sessionStorage.password;
		this.authenticateModel.password = sessionStorage.password;
	...
	tenencySearching() {
        ...
        return this._tokenAuthService.tenentSearching(this.authenticateModel);
    ...
    private login(accessToken: string, encryptedAccessToken: string, expireInSeconds: number, rememberMe?: boolean, twoFactorRememberClientToken?: string, redirectUrl?: string): void {
        ...
        if (twoFactorRememberClientToken) {
            this._utilsService.setCookieValue(
                SwitchService.twoFactorRememberClientTokenName,
