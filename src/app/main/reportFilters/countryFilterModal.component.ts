...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => CountryFilterComponent ),
  multi: true
};

@Component({
  selector: 'countryFilterModal',
  templateUrl: './countryFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class CountryFilterComponent  implements OnInit, ControlValueAccessor {
