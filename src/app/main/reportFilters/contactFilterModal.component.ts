...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => ContactFilterComponent),
  multi: true
};

@Component({
  selector: 'contactFilterModal',
  templateUrl: './contactFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class ContactFilterComponent  implements OnInit, ControlValueAccessor {
