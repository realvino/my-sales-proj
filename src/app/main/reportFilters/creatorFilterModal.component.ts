...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => CreatorFilterComponent),
  multi: true
};

@Component({
  selector: 'creatorFilterModal',
  templateUrl: './creatorFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class CreatorFilterComponent  implements OnInit, ControlValueAccessor {
