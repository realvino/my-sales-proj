...
import { ProfileServiceProxy, UpdateProfilePictureInput, UserServiceProxy } from "@shared/service-proxies/service-proxies";
...
export class ChangeProfilePictureModalComponent extends AppComponentBase {
    ...
    save(): void {
        ...
        self._profileService.updateProfilePicture(input)
            ...
            .subscribe(() => {
                this._userService.generateProfilePicture().subscribe(()=>{});
                let self = this;
                self._$jcropApi.destroy();
