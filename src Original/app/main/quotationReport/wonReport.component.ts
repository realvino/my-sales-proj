...
@Component({
    templateUrl: './wonReport.component.html',
    animations: [appModuleAnimation()]
})

export class WonReportComponent extends AppComponentBase implements AfterViewInit {
   ...
   constructor(
    ...
    getWonReport(event?: LazyLoadEvent): void {
        let data;
        ...
        this._reportService.getQuotationWonReport(
            this.filterText,
