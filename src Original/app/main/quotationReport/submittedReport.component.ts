...
@Component({
    templateUrl: './submittedReport.component.html',
    animations: [appModuleAnimation()]
})

export class SubmittedReportComponent extends AppComponentBase implements AfterViewInit {
   ...
   constructor(
    ...
    getSubmittedReport(event?: LazyLoadEvent): void {
        let data;
        ...
        this._reportService.getQuotationSubmittedReport(
            this.filterText,
