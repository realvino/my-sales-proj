...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => CurrencyFilterComponent ),
  multi: true
};

@Component({
  selector: 'currencyFilterModal',
  templateUrl: './currencyFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class CurrencyFilterComponent  implements OnInit, ControlValueAccessor {
