...
export const PICK_LIST_MENU_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => MileStoneFilterComponent ),
  multi: true
};

@Component({
  selector: 'mileStoneFilterModal',
  templateUrl: './mileStoneFilterModal.component.html',
  providers: [PICK_LIST_MENU_VALUE_ACCESSOR]
})
export class MileStoneFilterComponent  implements OnInit, ControlValueAccessor {
